/****************************************************************************
** Meta object code from reading C++ file 'read_thread.h'
**
...
#error "The header file 'read_thread.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 11, 11), // "frame_ready"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 11) // "stop_thread"

    },
    "ReadThread\0frame_ready\0\0stop_thread"
};
...
void ReadThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ReadThread::frame_ready)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ReadThread::frame_ready(const QImage & _t1)
{
