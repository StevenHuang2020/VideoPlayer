	...
	do {
		...
		if (got_frame) {
			...
			reconfigure =
				...
				is->audio_filter_src.channel_layout.nb_channels != dec_channel_layout.nb_channels ||
			...
			if (reconfigure || is->req_afilter_reconfigure) {
				...
				av_channel_layout_describe(&is->audio_filter_src.channel_layout, buf1, sizeof(buf1));
